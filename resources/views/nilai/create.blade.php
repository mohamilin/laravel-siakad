        ...
        <div class="col-md-6">
          ...
          <div class="form-group mb-3">
            ...
            <select name="id_siswa" id="" class="form-control">
              @foreach ($siswa as $d)
                <option value="{{ $d->id_siswa }}">{{ $d->nis . ' - '. $d->nama_siswa }}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group mb-3">
            <label for="" class="text-sm font-weight-bold">Nilai Tugas 1</label>
            <input type="text" class="form-control" name="nilai_tugas1" required>
          </div>
          <div class="form-group mb-3">
            <label for="" class="text-sm font-weight-bold">Nilai Tugas 2</label>
            <input type="text" class="form-control" name="nilai_tugas2" required>
          </div>
          <div class="form-group mb-3">

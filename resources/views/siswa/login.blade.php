        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              @endif
              <form role="form" action="{{ url('/login-siswa') }}" method="POST">
                {{ csrf_field() }}
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="NIS" type="text" name="nis">
                  </div>
                </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="{{ url('/login-guru') }}" class="text-light"><small>Login Sebagai Guru</small></a>
            </div>
          </div>
        </div>
      </div>
